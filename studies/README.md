...
mount table instead of re-adopting the legacy string-rendering shape it replaces (hardcoded
host paths as string literals, no way to catch a typo'd category) — see the top-level README's
"What nixlxc replaces" for the short version, in the meantime.
